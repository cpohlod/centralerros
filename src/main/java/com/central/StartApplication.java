...
public class StartApplication implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        loginRepo.save(new Login("abc", "abc@abc.com", "123456"));
        loginRepo.save(new Login("cleverson", "cleverson@softplan.com.br", "123456"));
        loginRepo.save(new Login("marcelo", "marcelo@hotmail.com", "123456"));
        loginRepo.save(new Login("jaquiel", "jaquiel.paim@gmail.com", "123456"));
        loginRepo.save(new Login("jerson", "jersonseling@yahoo.com.br", "123456"));
